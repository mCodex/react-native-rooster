 ...
 *
 * Render once anywhere in your tree (typically as a sibling of your app root).
 * Renders nothing until the first toast appears, so it has zero cost when
 * idle.
 *
 * @example
 * <>
 *   <App />
 *   <Toaster config={{ position: { vertical: 'top' } }} />
 * </>
 */
